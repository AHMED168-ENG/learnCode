...
export class PackageController {
  ...
  public listPage(req: Request, res: Response, next: NextFunction) {
    return res.render("website/views/package/list.ejs", { title: "Packages" });
  }
  ...
  public async viewPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const module_id = await new ModulesController().getModuleIdByName("Packages Management");
      return res.render("website/views/package/view.ejs", { title: "View Package Details", data, module_id });
    } catch (error) {
  ...
  public async newPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.render("website/views/package/new.ejs", { title: "Package new", destinations, providers });
    } catch (error) {
  ...
  public async editPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const module_id = await new ModulesController().getModuleIdByName("Packages Management");
      return res.render("website/views/package/edit.ejs", { title: "Edit Package", data, destinations, providers, module_id });
    } catch (error) {
  ...
  public async getAllDestinationPackages(lang: string, destination_id?: number) {
    try {
      ...
      const packagesData = await packages.findAll({ where, attributes: ["id", `${lang}_name`, "image"], raw: true });
