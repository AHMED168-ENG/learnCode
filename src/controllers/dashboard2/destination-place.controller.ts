...
export class DestinationPlaceController {
  ...
  public listPage(req: Request, res: Response, next: NextFunction) {
    return res.render("dashboard2/views/destination-places/list.ejs", { title: "Destination Places" });
  }
  ...
  public async newPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.render("dashboard2/views/destination-places/new.ejs", { title: "Destination Place new", destinations });
    } catch (error) {
