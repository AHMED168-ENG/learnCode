...
function getList(page) {
    ...
    $.ajax(settings).done(function (res, textStatus) {
        ...
        spinnerNotfound(2)
        if (res.canAdd) {
            $('#addNewBtn').html(`<a type="button" href="/dashboard2/package/new" class="btn btn-info">Add new</a>`)
        }
        ...
        if (res.canEdit) {
            res.data.forEach((elem) => {
                ...
                <td>
                    <a class="m-1" data-tooltip="View Package" href="/dashboard2/package/view/${elem.id}"><i class="fas fa-eye"></i></a>
                    <a class="m-1" href="/dashboard2/package/edit/${elem.id}"><i class="fas fa-edit text-primary"></i></a>
            ...
            res.data.forEach((elem) => {
                ...
                <td>
                    <a class="m-1" data-tooltip="View Package" href="/dashboard2/package/view/${elem.id}"><i class="fas fa-eye"></i></a></td>
                </tr>`)
            })
        }
