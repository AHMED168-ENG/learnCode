...
function getList(page) {
    ...
    $.ajax(settings).done(function (res, textStatus) {
        ...
        spinnerNotfound(2)
        // if (res.canAdd) {
        //     $('#addNewBtn').html(`<a type="button" href="/dashboard2/ticket/new" class="btn btn-info">Add new</a>`)
        // }
        ...
        if (res.canEdit) {
            res.data.forEach((elem) => {
                ...
                <td>
                    <a class="m-1" data-tooltip="View Ticket" href="/dashboard2/ticket/view/${elem.id}"><i class="fas fa-eye"></i></a>
            ...
            res.data.forEach((elem) => {
                ...
                <td><span class="badge badge-${placeStatusColor}">${elem.status}</span></td>
                <td>
                    <a class="m-1" data-tooltip="View Ticket" href="/dashboard2/ticket/view/${elem.id}"><i class="fas fa-eye"></i></a></td>
                </tr>`)
            })
        }
