...
export class ActivityController {
  ...
  public listPage(req: Request, res: Response, next: NextFunction) {
    return res.render("dashboard2/views/activity/list.ejs", { title: "Activities" });
  }
  ...
  public async newPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.render("dashboard2/views/activity/new.ejs", { title: "activity new", destinations, activityCategories });
    } catch (error) {
