...
function getList(page) {
    ...
    $.ajax(settings).done(function (res, textStatus) {
        ...
        spinnerNotfound(2)
        if (res.canAdd) {
            $('#addNewBtn').html(`<a type="button" href="/dashboard/destination-place/new" class="btn btn-info">Add new</a>`)
        }
        ...
        if (res.canEdit) {
            res.data.forEach((elem) => {
                ...
                <td>
                    <a class="m-1" data-tooltip="View Destination Place" href="/dashboard/destination-place/view/${elem.id}"><i class="fas fa-eye"></i></a>
                    <a class="m-1" href="/dashboard/destination-place/edit/${elem.id}"><i class="fas fa-edit text-primary"></i></a>
            ...
            res.data.forEach((elem) => {
                ...
                <td>
                    <a class="m-1" data-tooltip="View Destination Place" href="/dashboard/destination-place/view/${elem.id}"><i class="fas fa-eye"></i></a></td>
                </tr>`)
            })
        }
