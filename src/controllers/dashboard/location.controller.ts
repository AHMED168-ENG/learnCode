...
export class LocationController {
  listPage(req: Request, res: Response, next: NextFunction) {
    res.render("dashboard/views/location/list.ejs", {
      title: "Location",
    })
  }
    ...
    initiativeLocations
      ...
      .then((data) => {
        initiativeLocations
          .count()
          .then(async (count) => {
            const permissions = await new UserPermissionsController().getUserPermissions(req.cookies.token, "Locations Management");
            const dataInti = {
              total: count,
              limit: limit,
  ...
  async newPage(req: Request, res: Response, next: NextFunction) {
    ...
    res.render("dashboard/views/location/new.ejs", {
      title: "Location new",
      initiatives,
      countries,
    })
  ...
  async editPage(req: Request, res: Response, next: NextFunction) {
    ...
    initiativeLocations.findOne({where: {location_id: id}, raw: true}).then((data) => {
      res.render("dashboard/views/location/edit.ejs", {
        title: "Edit Location",
        data: data,
        initiatives,
        countries,
  ...
  async viewPage(req: Request, res: Response, next: NextFunction) {
    ...
    const countries = await new CountryController().listCountry()
    initiativeLocations.findOne({where: {location_id: id}, raw: true}).then((data) => {
      res.render("dashboard/views/location/view.ejs", {
