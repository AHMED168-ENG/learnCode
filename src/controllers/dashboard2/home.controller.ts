...
import {InitiativeController} from "../dashboard/initiative.controller"
import {OrderController} from "../dashboard/order.controller"
import {SponserController} from "../dashboard/sponser.controller"
import {MessageController} from "../dashboard/message.controller"
...
export class HomeController {
  async home(req: Request, res: Response, next: NextFunction) {
    ...
    res.render("dashboard2/views/index.ejs", {
      title: "Home",
