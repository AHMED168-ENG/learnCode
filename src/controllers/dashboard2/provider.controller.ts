...
export class ProviderController {
  ...
  public listPage(req: Request, res: Response, next: NextFunction) {
    return res.render("dashboard2/views/provider/list.ejs", { title: "Providers" });
  }
  ...
  public async newPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.render("dashboard2/views/provider/new.ejs", { title: "provider new", destinations });
    } catch (error) {
