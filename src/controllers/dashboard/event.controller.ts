...
export class EventController {
  ...
  public listPage(req: Request, res: Response, next: NextFunction) {
    return res.render("dashboard/views/event/list.ejs", { title: "Events" });
  }
  ...
  public async newPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.render("dashboard/views/event/new.ejs", { title: "event new", destinations, eventCategories, audienceCategories, cities });
    } catch (error) {
