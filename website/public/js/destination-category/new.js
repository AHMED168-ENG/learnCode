...
$(function () {
    ...
    $('#newForm').validate({
        rules: { ar_name: { required: true }, en_name: { required: true } },
        messages: { ar_name: "Please enter a arabic name", en_name: "Please enter a english name" },
        errorElement: 'span',
...
const addNew = () => {
    ...
    $.ajax({
        ...
        $('.toast-body').text("New Destination Interest Category add Successful")
        $('.toast').toast("show")
    }).fail(function (xhr) {
