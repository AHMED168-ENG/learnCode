...
export class HotelController {
  public listPage(req: Request, res: Response, next: NextFunction) {
    return res.render("dashboard2/views/hotel/list.ejs", { title: "Hotels" });
  }
  ...
  public async viewPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const module_id = await new ModulesController().getModuleIdByName("Destinations Hotels");
      return res.render("dashboard2/views/hotel/view.ejs", { title: "View hotel Details", data, module_id });
    } catch (error) {
  ...
  public async newPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.render("dashboard2/views/hotel/new.ejs", { title: "hotel new", destinations });
    } catch (error) {
  ...
  public async editPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const module_id = await new ModulesController().getModuleIdByName("Destinations Hotels");
      return res.render("dashboard2/views/hotel/edit.ejs", { title: "Edit hotel", data, destinations, module_id });
    } catch (error) {
