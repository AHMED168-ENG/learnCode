...
export class StoreController {
  ...
  public listPage(req: Request, res: Response, next: NextFunction) {
    return res.render("website/views/store/list.ejs", { title: "Stores" });
  }
  ...
  public async viewPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const module_id = await new ModulesController().getModuleIdByName("Store Management");
      return res.render("website/views/store/view.ejs", { title: "View Store Details", data, module_id });
    } catch (error) {
  ...
  public async newPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.render("website/views/store/new.ejs", { title: "Store new", destinations });
    } catch (error) {
  ...
  public async editPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const module_id = await new ModulesController().getModuleIdByName("Store Management");
      return res.render("website/views/store/edit.ejs", { title: "Edit Store", data, destinations, module_id });
    } catch (error) {
