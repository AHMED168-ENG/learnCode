    ...
    $.ajax(settings).done(function (res, textStatus) {
        ...
        if (res.canEdit) {
            res.data.forEach((elem) => {
                ...
                <td>
                    <a class="m-1" data-tooltip="View Tour Guide" href="/dashboard/guide/view/${elem.id}"><i class="fas fa-eye"></i></a>
                    <a class="m-1" href="/dashboard/guide/edit/${elem.id}"><i class="fas fa-edit text-primary"></i></a>
            ...
            res.data.forEach((elem) => {
                ...
                <td><a data-tooltip="View Tour Guide" class="btn btn-info" href="/dashboard/guide/view/${elem.id}"><i class="fas fa-eye"></i></a></td>
                </tr>`)
            })
        }
