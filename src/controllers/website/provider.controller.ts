...
export class ProviderController {
  ...
  public listPage(req: Request, res: Response, next: NextFunction) {
    return res.render("website/views/provider/list.ejs", { title: "Providers" });
  }
  ...
  public async viewPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const module_id = await new ModulesController().getModuleIdByName("Providers Management");
      return res.render("website/views/provider/view.ejs", { title: "View provider Details", data, module_id });
    } catch (error) {
  ...
  public async newPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.render("website/views/provider/new.ejs", { title: "provider new", destinations });
    } catch (error) {
  ...
  public async editPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const module_id = await new ModulesController().getModuleIdByName("Providers Management");
      return res.render("website/views/provider/edit.ejs", { title: "Edit provider", data, destinations, module_id });
    } catch (error) {
