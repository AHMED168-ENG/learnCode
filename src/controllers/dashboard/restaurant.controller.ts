...
export class RestaurantController {
  ...
  public async viewPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const module_id = await new ModulesController().getModuleIdByName("Destinations Restaurants");
      return res.render("dashboard/views/restaurant/view.ejs", { title: "View restaurant Details", data, module_id });
    } catch (error) {
  ...
  public async newPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.render("dashboard/views/restaurant/new.ejs", { title: "restaurant new", destinations });
    } catch (error) {
  ...
  public async editPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const module_id = await new ModulesController().getModuleIdByName("Destinations Restaurants");
      return res.render("dashboard/views/restaurant/edit.ejs", { title: "Edit restaurant", data, destinations, module_id });
    } catch (error) {
