...
export class TravelController {
  ...
  public listPage(req: Request, res: Response, next: NextFunction) {
    return res.render("dashboard/views/travel/list.ejs", { title: "Travel Essentials" });
  }
  ...
  public async newPage(req: Request, res: Response, next: NextFunction) {
    try {
      return res.render("dashboard/views/travel/new.ejs", { title: "travel essentials new" });
    } catch (error) {
  ...
  public async editPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.render("dashboard/views/travel/edit.ejs", { title: "Edit travel essentials", data });
    } catch (error) {
