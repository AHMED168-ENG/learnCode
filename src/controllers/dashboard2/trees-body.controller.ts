...
export class TreesBodyController {
    ...
    public newPage(req: Request, res: Response, next: NextFunction) {
        return res.render("dashboard/views/trees-bodies/new.ejs", { title: "Add Trees Body" });
    }
    ...
    public async editPage(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            return res.render("dashboard/views/trees-bodies/edit.ejs", { title: "Edit Trees Body", data });
        } catch (error) {
