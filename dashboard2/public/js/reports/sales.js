...
function getList(type = "all", from = null, to = null) {  // show spinner
    ...
    const settings = {
        async: true,
        crossDomain: true,
        url: `/dashboard2/order/completed/listreport?from=${from}&to=${to}`,
        method: "Get",
    }
    $.ajax(settings).done(function (res) {
        ...
        res.data.forEach((elem, i) => {
            ...
            <td class="text-center"><a href="/dashboard2/order/view/${elem.order_id}" data-tooltip="View order">${elem.order_id}</a></td>
