...
export class TicketController {
  ...
  public listPage(req: Request, res: Response, next: NextFunction) {
    return res.render("website/views/ticket/list.ejs", { title: "Tickets" });
  }
  ...
  public async viewPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const module_id = await new ModulesController().getModuleIdByName("Tickets Booking Management");
      return res.render("website/views/ticket/view.ejs", { title: "View ticket Details", data, module_id });
    } catch (error) {
  ...
  public async newPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.render("website/views/ticket/new.ejs", { title: "ticket new", destinations, providers });
    } catch (error) {
  ...
  public async editPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const module_id = await new ModulesController().getModuleIdByName("Tickets Booking Management");
      return res.render("website/views/ticket/edit.ejs", { title: "Edit Ticket", data, destinations, providers, module_id });
    } catch (error) {
