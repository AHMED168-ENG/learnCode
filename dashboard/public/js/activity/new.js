...
$(function () {
    ...
    $('#newForm').validate({
        rules: {
            ...
            activity_category_id: { required: true },
        ...
        messages: {
            ...
            activity_category_id: "Please enter a activity category",
        },
        errorElement: 'span',
...
const addNew = () => {
    ...
    formData.append("activity_category_id", $("#activity_category_id").val());
    ...
    $.ajax({
        ...
        $('.toast-body').text("New Activity add Successful")
        $('.toast').toast("show")
    }).fail(function (xhr) {
