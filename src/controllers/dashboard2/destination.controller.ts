...
export class DestinationController {
  ...
  public listPage(req: Request, res: Response, next: NextFunction) {
    return res.render("dashboard2/views/destinations/list.ejs", { title: "Destination" });
  }
  ...
  public async newPage(req: Request, res: Response, next: NextFunction) {
    return res.render("dashboard2/views/destinations/new.ejs", { title: "Destination new" });
  }
