...
export class EventController {
  ...
  public listPage(req: Request, res: Response, next: NextFunction) {
    return res.render("dashboard2/views/event/list.ejs", { title: "Events" });
  }
  ...
  public async viewPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const module_id = await new ModulesController().getModuleIdByName("Events Management");
      return res.render("dashboard2/views/event/view.ejs", { title: "View event Details", data, module_id });
    } catch (error) {
  ...
  public async newPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.render("dashboard2/views/event/new.ejs", { title: "event new", destinations, eventCategories, cities });
    } catch (error) {
  ...
  public async addNew(req: Request, res: Response, next: NextFunction) {
    try {
      const areNull = !req.body.ar_name || !req.body.en_name || !req.body.from || !req.body.to || !req.files;
  ...
  public async editPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const module_id = await new ModulesController().getModuleIdByName("Events Management");
      return res.render("dashboard2/views/event/edit.ejs", { title: "Edit event", data, destinations, eventCategories, cities, module_id });
    } catch (error) {
