...
function getList(page) {
    ...
    $.ajax(settings).done(function (res, textStatus) {
        ...
        res.data.forEach((elem) => {
            ...
            <td><a class="pr-2" href="/dashboard/tree/${elem.tree_id}"><i class="fas fa-eye text-success"></i></a><a class="pr-2" href="/dashboard/tree/edit/${elem.tree_id}"><i class="fas fa-edit text-primary"></i></a></td>
            </tr>`)
        })
