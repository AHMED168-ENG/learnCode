...
function getList(page) {
    ...
    $.ajax(settings).done(function (res, textStatus) {
        ...
        spinnerNotfound(2)
        if (res.canAdd) {
            $('#addNewBtn').html(`<a type="button" href="/dashboard/event/new" class="btn btn-info">Add new</a>`)
        }
        ...
        if (res.canEdit) {
            res.data.forEach((elem) => {
                ...
                <td>${elem.tbl_event_category.en_name} - ${elem.tbl_event_category.ar_name}</td>
                <td>${elem.tbl_audience_category.en_name} - ${elem.tbl_audience_category.ar_name}</td>
                ...
                <td>
                    <a class="m-1" data-tooltip="View Event" href="/dashboard/event/view/${elem.id}"><i class="fas fa-eye"></i></a>
                    <a class="m-1" href="/dashboard/event/edit/${elem.id}"><i class="fas fa-edit text-primary"></i></a>
            ...
            res.data.forEach((elem) => {
                ...
                <td>
                    <a class="m-1" data-tooltip="View Event" href="/dashboard/event/view/${elem.id}"><i class="fas fa-eye"></i></a></td>
                </tr>`)
            })
        }
