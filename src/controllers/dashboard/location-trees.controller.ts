...
export class LocationTreesController {
  listPage(req: Request, res: Response, next: NextFunction) {
    res.render("dashboard/views/location-trees/list.ejs", {
  ...
  async newPage(req: Request, res: Response, next: NextFunction) {
    ...
    res.render("dashboard/views/location-trees/new.ejs", {
  ...
  async editPage(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      return res.render("dashboard/views/location-trees/edit.ejs", { title: "Edit location Trees", data, initiatives: initiativesData, countries, trees: treesData, initiativeLocations: initiativeLocationsData });
    } catch (error) {
      console.log(error)
